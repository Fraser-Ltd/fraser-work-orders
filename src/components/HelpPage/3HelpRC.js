                ...
                >
                    <Grid item xs={10}>
                        <Paper>
                            ...
                            <Typography className={classes.textIndent} variant='body2'>All open work orders will show here along with their status of completion.  Resident Coordinators may click on and edit work orders in this table if necessary.</Typography> <br />
