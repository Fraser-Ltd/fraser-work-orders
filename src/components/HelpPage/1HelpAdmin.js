                ...
                >
                    <Grid item xs={10}>
                        <Paper>
                            ...
                            <br /> <br />
                            <Typography className={classes.h4} variant='h4'>3.0 Getting Started</Typography>
                            ...
                            <Typography className={classes.caption} variant='body2'>3.2.1 Setting up Properties</Typography> <br />
                            ...
                            <Typography className={classes.textIndent} variant='body2'>Once logged in, all users will be automatically directed to the Work Orders Page.  Note this page will look different depending on the User Role.</Typography> <br /><br />
                            <Typography className={classes.caption} variant='body2'>4.1.1 Work Orders to Assign</Typography> <br />
                            ...
                            <Typography className={classes.caption} variant='body2'>4.1.2 Current Work Orders</Typography> <br />
                            ...
                            <Typography className={classes.caption} variant='body2'>4.1.3 Completed Work Orders</Typography> <br />
                            <Typography className={classes.textIndent} variant='body2'>Work orders that are complete will show up here.</Typography> <br /><br />
                            <Typography className={classes.caption} variant='body2'>4.1.4 Create New Work Order</Typography> <br />
                            ...
                            <Typography className={classes.caption} variant='body2'>4.2.1 Current Users</Typography>  <br />
                            ...
                            <Typography className={classes.caption} variant='body2'>4.2.2 Add New User</Typography>  <br />
                            ...
                            <Typography className={classes.caption} variant='body2'>4.2.3 Inactive Employees</Typography>  <br />
                            ...
                            <Typography className={classes.caption} variant='body2'>4.3.1 Current Properties</Typography>  <br />
                            ...
                            <Typography className={classes.caption} variant='body2'>4.3.2 Add Properties</Typography>  <br />
                            ...
                            <Typography className={classes.caption} variant='body2'>4.4.1 Completed Work Orders Report</Typography>  <br />
